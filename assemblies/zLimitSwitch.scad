// zLimitSwitch Assembly

zLimitSwitchOffset = 40;


zLimitSwitchBracket_connectors = [
	[[0,0,0],[0,0,1],0],  // frame fixing
	[[0,-zLimitSwitchOffset,13],[0,0,-1],-90]   // microswitch
];


module zLimitSwitchBracket_stl(noSnapFitting=false) {

	con = zLimitSwitchBracket_connectors;
...
zLimitSwitchAssembly_connnectors = [
	[[0,0,0],[0,0,1],0]  // attach to x rail
];

module zLimitSwitchAssembly() {

	con = zLimitSwitchAssembly_connnectors;
	bcon = zLimitSwitchBracket_connectors;
	mcon = microswitch2_connectors;
